    ...
    <section className="relative w-full">
      ...
      <div className="relative flex flex--col sm:flex-row items-center sm:space-x-11 mx-auto w-full max-w-7xl py-8 px-2.5">
        ...
        <div className="space-y-3 lg:space-y-4 xl:space-y-6">
          {/* Eyebrow */}
          <h4 className="mb--6 text-base font-bold tracking--wider text-tmc-blue uppercase">
            Empower Your Financial Journey
          </h4>

          {/* Heading */}
          <h2 className="text-lg md:text-2xl lg:text-3xl xl:text-[32px] font-medium text-green-darker">
            What Should I Know?
          </h2>
          
          {/* Description */}
          <p className="max-w-xl mb-3 text-gray-1 text-base font-normal leading-8">
